...
for train, test in kfold.split(stores, origin_y):
    model10_stores, instore = ResNet50(input_shape=stores.shape[1:], layer_num=15)
    model10_roads, inroad = ResNet50(input_shape=roads.shape[1:], layer_num=15)
    model10_pois, in3poi = ResNet50(input_shape=pois.shape[1:], layer_num=15)
